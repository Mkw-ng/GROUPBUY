 ...
 * status: pending = awaiting payment, invoice_issued = invoice sent via WhatsApp, paid = payment confirmed, cancelled = order cancelled
 */
export const orders = mysqlTable("orders", {
  ...
  status: mysqlEnum("status", ["pending", "invoice_issued", "paid", "cancelled"]).notNull().default("pending"),
